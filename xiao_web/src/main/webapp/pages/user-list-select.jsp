...
<%--									&lt;%&ndash;									<select class="form-control" id="changePageSize" onchange="changePageSize()">&ndash;%&gt;--%>
...
<%--									&lt;%&ndash;										<option>${pageInfo.total}</option>&ndash;%&gt;--%>
<%--									&lt;%&ndash;									</select> 条&ndash;%&gt;--%>
<%--								</div>--%>
...
<%--										&lt;%&ndash;										<li class="am-active"><a href="#">1</a></li>&ndash;%&gt;--%>
