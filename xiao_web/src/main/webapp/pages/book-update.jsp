            ...
            <div class="tpl-block ">
                ...
                <div class="am-g tpl-amazeui-form">
                    ...
                    <div class="am-u-sm-12 am-u-md-9">
                        <form class="am-form am-form-horizontal" action="${pageContext.request.contextPath}/book/update.do"
                              method="post" enctype="multipart/form-data">
                            <div class="am-form-group">
                                <label for="user-name" class="am-u-sm-3 am-form-label">ISBN(必填)</label>
                                <div class="am-u-sm-9">
                                    <input name="book_isbn" id="queryValue" type="text" value="${book.book_isbn}">
                                </div>
                            </div>
                            <div class="am-form-group">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <select data-am-selected="{searchBox: 1}" name="c_id">
                                        <option value="${book.category.c_id}" selected="selected">${book.category.c_name}</option>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input name="book_price" type="text" value="${book.book_price}">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label for="user-name" class="am-u-sm-3 am-form-label">出版社</label>
                                <div class="am-u-sm-9">
                                    <input name="book_public" type="text" value="${book.book_public}">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label for="user-name" class="am-u-sm-3 am-form-label">作者</label>
                                <div class="am-u-sm-9">
                                    <input name="book_author" type="text" value="${book.book_author}">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label for="user-name" class="am-u-sm-3 am-form-label">出版时间</label>
                                <div class="am-u-sm-9">
                                    <input name="book_year" type="text" value="${book.book_year}">
                                </div>
                            </div>
                            <%--                            //库存--%>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input name="book_count" type="number" pattern="[0-9]*" id="user-QQ" value="${book.book_count}">
                                </div>
                            </div>
                            <%--                            //类别--%>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <select data-am-selected="{searchBox: 1}" name="out">
                                        <option value="${book.out}" selected="selected">${book.outStr}</option>
                                        <c:choose>
                                ...
                                <div class="am-form-group">
                                    <label for="user-weibo" class="am-u-sm-3 am-form-label">图书封面 <span class="tpl-form-line-small-title"></span></label>
                                    <div class="am-u-sm-9">
                            ...
                            <div class="am-form-group">
                                <div class="am-u-sm-9 am-u-sm-push-3">
                                    ...
                                    <button onclick="location.href='${pageContext.request.contextPath}/book/findAll.do?page=1&size=20'" type="button" class="am-btn am-btn-primary">返回</button>
                                </div>
                            </div>
                        </form>
                    </div>
