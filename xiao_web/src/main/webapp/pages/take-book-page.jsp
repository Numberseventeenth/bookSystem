						...
						<form id="form" class="am-form am-form-horizontal">
							...
							<div class="am-form-group">
								<div class="am-u-sm-9 am-u-sm-push-3">
									<button type="button" class="am-btn am-btn-primary">取走</button>
								</div>
							</div>
						</form>
						<div id="tishi">
...
<script type="text/javascript">
	$(function() {
		$("#word").keyup(function() {
			...
			if(queryValue == ""){
				...
				//3. 请求数据。
				$.post("http://localhost:81/xiao/user/queryUserAndAdvanceBook.do",{queryValue:queryValue} ,function(data , status){
					// alert(data);
					$("#tishi").show();
					$("#tishi").html(data);
				});
	...
	$("#form button").click(function () {
		...
		$.post("http://localhost:81/xiao/advance/takeBook.do",
				{user_id:user_id,
					book:book} ,
				function(data , status){
					if(data == 1){
						swal("操作成功！", "用户取走成功","success")
					}else{
